...
interface Methods12MenuProps {
  startNewGame: (mode: GameMode) => void;
}

const Methods12Menu: React.FC<Methods12MenuProps> = ({ startNewGame }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-slate-50 dark:bg-slate-900 transition-colors">
      <div className="mb-12 text-center">
        ...
        <p className="text-slate-500 dark:text-slate-400 font-medium tracking-wide">Year 12 Mathematical Methods</p>
      </div>

      <div className="w-full max-w-4xl space-y-8">
        <div>
          <h2 className="text-xl font-bold whitespace-nowrap text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-4 px-2">Core Topics</h2>
